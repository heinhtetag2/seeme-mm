  ...
  return (
    <div className="absolute inset-0 z-40 bg-canvas flex flex-col animate-fade-in">
      <div className="flex-1 flex flex-col items-center justify-center px-8 text-center">
        <div className="kicker mb-3">{t('book.success.kicker')}</div>
        <h1 className="font-serif text-[34px] leading-[1.05] tracking-tight font-semibold text-balance">
          {t('book.success.headlineA')}<br />
          <span className="italic">{t('book.success.headlineB')}</span>
        </h1>
        ...
        <div className="mt-10 w-full max-w-[280px] relative">
          ...
          <div className="rounded-2xl border border-line/70 bg-surface-elevated px-5 py-6 text-left">
            <div className="kicker mb-1">{t('book.success.confirmation')}</div>
      ...
      <div className="px-5 pb-10 space-y-3">
        <button
          ...
          className="w-full h-12 rounded-full bg-brand text-white text-[14px] font-semibold leading-none inline-flex items-center justify-center"
        >
